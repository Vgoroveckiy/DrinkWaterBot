...
def start_message(message):
    bot.send_message(message.chat.id, "Привет, я чат бот, который будет напоминать тебе пить воду!")
    send_water_reminder_thread = threading.Thread(target=send_water_reminder, args=(message.chat.id,))
...
def fact_message(message):
    ...
    bot.send_message(message.chat.id, f"Лови интересный факт о воде:\n{random.choice(facts_about_water)}")
